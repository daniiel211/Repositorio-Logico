    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('gerente', 'Gerente General'), ('supervisor', 'Supervisor'), ('operador', 'Operador'), ('motorista', 'Motorista')], default='operador', max_length=20, verbose_name='Rol del usuario')),
